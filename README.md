...
3. [Generate basic Javascript, CSS & Sass scaffolding](#generate-command):
    ...
    ```
    **Note:** Above command will generate scaffolding for vue, but you can generate jQuery/Bootstrap, or React scaffolding too.
...
Doesn't like Vue.js? Don't worry this plugin doesn't dictate on which javascript library you should use. This plugin provides ability to quickly generate scaffolding for Vue as well as Bootstrap, and React.
